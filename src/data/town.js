...
export const PLACES = [
  ...
  { id: 'mission-peak-trailhead', name: 'The Stanford Avenue Trailhead', lat: 37.5100, lng: -121.9060, district: 'Mission San José', motifs: ['peak', 'gate', 'trail'], fame: 1 },
  { id: 'monument-peak', name: 'Monument Peak', lat: 37.4570, lng: -121.8680, district: 'Mission San José', motifs: ['peak', 'towers', 'grass'], fame: 1 },
  ...
  { id: 'lake-elizabeth-south', name: 'The Warm Springs Community Center', lat: 37.4870, lng: -121.9330, district: 'Warm Springs', motifs: ['civic', 'lawn', 'oaks'], fame: 3 },
  { id: 'higuera', name: 'The Higuera adobe site', lat: 37.4790, lng: -121.9180, district: 'Warm Springs', motifs: ['ridge', 'adobe', 'oaks'], fame: 3 },
  { id: 'south-sundale', name: 'Sundale', lat: 37.5080, lng: -121.9700, district: 'Warm Springs', motifs: ['tract', 'lawn', 'road'], fame: 3 },
  ...
  { id: 'sabercat', name: 'Sabercat Historical Park', lat: 37.5230, lng: -121.9430, district: 'Irvington', motifs: ['ridge', 'creek', 'trail'], fame: 1 },
  ...
  { id: 'washington-hospital', name: 'Washington Hospital', lat: 37.5410, lng: -121.9800, district: 'Irvington', motifs: ['civic', 'lot', 'flagpole'], fame: 2 },
  { id: 'tule-ponds', name: 'Tule Ponds at Tyson Lagoon', lat: 37.5410, lng: -121.9560, district: 'Irvington', motifs: ['pond', 'tules', 'boardwalk'], fame: 1 },
  ...
  { id: 'niles-flea', name: 'The Niles Flea Market', lat: 37.5790, lng: -121.9750, district: 'Niles', motifs: ['shops', 'awnings', 'road'], fame: 1 },
  ...
  { id: 'niles-plaza', name: 'Niles Town Plaza', lat: 37.5788, lng: -121.9744, district: 'Niles', motifs: ['plaza', 'shops', 'oaks'], fame: 1 },
  { id: 'niles-boulevard', name: 'Niles Boulevard', lat: 37.5789, lng: -121.9760, district: 'Niles', motifs: ['shops', 'awnings', 'poles'], fame: 1 },
  { id: 'california-nursery', name: 'The California Nursery Historical Park', lat: 37.5740, lng: -121.9830, district: 'Niles', motifs: ['orchard', 'barn', 'eucalyptus'], fame: 1 },
  ...
  { id: 'shinn-pond', name: 'Shinn Pond', lat: 37.5720, lng: -122.0230, district: 'Niles', motifs: ['water', 'quarry', 'tules'], fame: 2 },
  ...
  { id: 'patterson-house', name: 'The Patterson House', lat: 37.5573, lng: -122.0552, district: 'Ardenwood', motifs: ['victorian', 'lawn', 'eucalyptus'], fame: 1 },
  ...
  { id: 'pacific-commons', name: 'Pacific Commons', lat: 37.4970, lng: -121.9660, district: 'Ardenwood', motifs: ['shops', 'lot', 'marsh'], fame: 1 },
  ...
  { id: 'niles-junction', name: 'Niles Junction', lat: 37.5810, lng: -121.9800, district: 'Next door', motifs: ['tracks', 'poles', 'watertower'], fame: 3 },
  ...
  { id: 'hopkins-middle', name: 'Hopkins Junior High', lat: 37.5250, lng: -121.9330, district: 'Around town', motifs: ['school', 'field', 'oaks'], fame: 2 },
  ...
  { id: 'lake-elizabeth-dock', name: 'The Lake Elizabeth boat dock', lat: 37.5468, lng: -122.0050, district: 'Around town', motifs: ['water', 'dock', 'lawn'], fame: 2 },
  { id: 'central-park-fountain', name: 'The Central Park fountain', lat: 37.5480, lng: -122.0010, district: 'Around town', motifs: ['lawn', 'fountain', 'oaks'], fame: 2 },
  { id: 'aqua-adventure', name: 'Aqua Adventure', lat: 37.5455, lng: -122.0035, district: 'Around town', motifs: ['water', 'lawn', 'poles'], fame: 1 },
  ...
  { id: 'glenmoor', name: 'Glenmoor', lat: 37.5480, lng: -122.0050, district: 'Around town', motifs: ['tract', 'lawn', 'oaks'], fame: 2 },
