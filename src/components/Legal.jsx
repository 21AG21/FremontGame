...
const PRIVACY = [
  [
    ...
    [
      ...
      'Some days carry a sponsor: one local business, named under your result and labelled as the sponsor. It is a plain link and nothing more — the business puts no code on this page, sets nothing on your device, sees nothing about you, and has no say in the puzzles. There is no advertising network here, and nothing about you is sold or shared with anyone.',
      ...
      'The other exception is the sponsor link. If you tap a sponsor’s name, that tool is told which sponsor it was and the date, so the business can be told how many people came — that count is what they are paying for. It is not told anything about you, and nothing is sent if you do not tap it.',
